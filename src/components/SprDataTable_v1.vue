              ...
              <v-card-text>
                <v-container>
                  ...
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="3">
                      <v-radio-group
                        v-model="editedItem.PRIEM"
                        mandatory
                        label="Priem"
                      >
                        <v-radio label="Прием" value="1"></v-radio>
                        <v-radio label="Сдача" value="0"></v-radio>
                      </v-radio-group>
                    </v-col>
                    <!-- meas_subj -->
                    <v-col cols="12" sm="6" md="3">
                      <v-radio-group v-model="editedItem.MEAS_SUBJ">
                        <template v-slot:label>
                          <div>Предмет измерения</div>
                        </template>
                        <v-radio value="m">
                          <template v-slot:label>
                            <div>Масса (m)</div>
                    ...
                    <!-- <v-col cols="12" sm="6" md="3">
                      <v-radio-group
                        ...
                        mandatory
                        label="Активность записи"
                      >
                        <v-radio label="Активная" value="1"></v-radio>
                        <v-radio label="Неактивная" value="0"></v-radio>
                      </v-radio-group>
                    </v-col> -->
                  </v-row>
                </v-container>
...
export default {
  ...
  methods: {
    ...
    updateSprInTable() {
      ...
      fd.append("pPRIEM", this.editedItem.PRIEM);
      fd.append("pMEAS_SUBJ", this.editedItem.MEAS_SUBJ);
